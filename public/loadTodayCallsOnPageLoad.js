...
export async function loadTodayCallsOnPageLoad (numberOfPastDays) {
        ...
        try {
            // Fetch records from Mongo Database and then compare the records against Twilio api response
